...
public class CloneDetector {
    ...
    public static void main(String args[]) {
        ...
        if (args.length > 0) {
            ...
            cd.useJaccardSimilarity = args[2].equals(cd.SIMILARITY_JACCARD);
        } else {
            System.out
        ...
        try {
            ...
            cd.cloneHelper = new CloneHelper();
            cd.runExperiment();
        } catch (IOException e) {
            e.printStackTrace();
        } finally {
    ...
    private void runExperiment() {
        try {
            ...
            sb.append(end_time - start_time).append(",");
            System.out.println("comparisions :"
                    + this.cloneHelper.getComparisions());
            sb.append(this.cloneHelper.getComparisions()).append(",");
            sb.append(this.cloneHelper.getNumClonesFound()).append(",");
            System.out.println("threshold set to : " + this.threshold);
            sb.append(this.threshold).append(",");
