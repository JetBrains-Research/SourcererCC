...
public class ClonesBugsAssembler {
    ...
    public ClonesBugsAssembler() {
        super();
        this.clonesNameMap = new HashMap<>();
        this.methodListing = new HashMap<>();
        ...
        try {
            for (String method : methods) {
                ...
                if (!otherColumns.trim().equalsIgnoreCase("")) {
                    sb.append(Util.CSV_DELIMITER).append(otherColumns);
                }
                String clonesColumns = this.clonesNameMap.get(method);
                if (null != clonesColumns && !clonesColumns.trim().equalsIgnoreCase("")) {
                    sb.append(Util.CSV_DELIMITER).append(clonesColumns).append(Util.CSV_DELIMITER).append("1");
    ...
    private void appendSummary(int rows) {
        ...
        sb.append(Util.CSV_DELIMITER + "LOC" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",B:B)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",B:B)" + Util.CSV_DELIMITER + "=SUM(C").append(columnOffset).append(":D").append(columnOffset).append(")\n");
        sb.append(Util.CSV_DELIMITER + "BUGS" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",L:L)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",L:L)" + Util.CSV_DELIMITER + "=SUM(C").append(columnOffset + 1).append(":D").append(columnOffset + 1).append(")\n");
        sb.append(Util.CSV_DELIMITER + "DD" + Util.CSV_DELIMITER + "=(C").append(columnOffset + 1).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + 1).append("*1000)/").append("D").append(columnOffset).append(Util.CSV_DELIMITER).append("=SUM(C").append(columnOffset + 1).append(":D").append(columnOffset + 1).append(")\n");
        ...
        int offset = 4;
        sb.append("C" + Util.CSV_DELIMITER + "Style" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",C:C)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",C:C)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("D" + Util.CSV_DELIMITER + "Bad_Practice" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",D:D)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",D:D)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("E" + Util.CSV_DELIMITER + "Correctness" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",E:E)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",E:E)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("F" + Util.CSV_DELIMITER + "I18N" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",F:F)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",F:F)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("G" + Util.CSV_DELIMITER + "Security" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",G:G)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",G:G)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("H" + Util.CSV_DELIMITER + "Performance" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",H:H)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",H:H)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("I" + Util.CSV_DELIMITER + "MT_Correctness" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",I:I)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",I:I)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("J" + Util.CSV_DELIMITER + "Experimental" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",J:J)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",J:J)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        offset++;
        sb.append("K" + Util.CSV_DELIMITER + "Malicious_Code" + Util.CSV_DELIMITER + "=SUMIF(P:P,\"=0\",K:K)" + Util.CSV_DELIMITER + "=SUMIF(P:P,\">0\",K:K)" + Util.CSV_DELIMITER + "=(C").append(columnOffset + offset).append("*1000)/").append("C").append(columnOffset).append(Util.CSV_DELIMITER).append("=(D").append(columnOffset + offset).append("*1000)/").append("D").append(columnOffset).append("\n");
        sb.append("Total" + Util.CSV_DELIMITER + "" + Util.CSV_DELIMITER + "=SUM(C").append(columnOffset + 4).append(":C").append(columnOffset + offset).append(")").append(Util.CSV_DELIMITER).append("=SUM(D").append(columnOffset + 4).append(":D").append(columnOffset + offset).append(")").append("\n");
    ...
    private void populateClonesList() {
        ...
        for (String key : keys) {
            ...
            Collections.addAll(this.clones, cv);
        }
    }
